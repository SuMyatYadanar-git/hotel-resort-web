            ...
            <form className='py-3'>
                <div className='d-flex flex-row flex-wrap justify-content-between py-2'>
                    <div className='flex-fill  p-1'>
                        <MyInput id={'name'} placeHolder={'Name'} style={{fontColor:'#5A6367'}}/>  
                        
                    </div>
                    <div className='flex-fill  p-1'>
                        <MyInput id={'email'} placeHolder={'Email'} style={{fontColor:'#5A6367'}}/>
                    </div>
                </div>
                
                {/* <div className='d-flex flex-row flex-wrap'>
                    <div className='d-flex flex-column py-2 w-50 '>
                        <MyInput id={'name'} placeHolder={'Name'} style={{fontColor:'#5A6367'}}/>  
                    </div>
                    <div className='d-flex flex-column py-2 w-50 '>
                        <MyInput id={'email'} placeHolder={'Email'} style={{fontColor:'#5A6367'}}/>  
